...
public class PlayGame{
     ...
     * A map takes an input (in this case character) and "maps" it to a value (in this case a string!)
	 */
	...
	public static void main(String[] args){
		...
		while(scanner.hasNextLine()){
            ...
            else if (tmp.charAt(2) == 'v'){
                deck.add(new UnoReverseCard(cardConvert.get(tmp.charAt(0)), -1));
            }
			else{
        ...
        //A responsible person closes their scanner!
		scanner.close();
